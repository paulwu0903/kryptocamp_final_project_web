...
export default function TreasuryPage() {
  const {contract} = useContract(TOKEN_TREASURY_ADDRESS);
                        ...
                        <Web3Button
                          ...
                          action={async()=>{
                            if (transactionType == 0){
                              ...
                              await contract.call('submitTransaction', [transactionType, saleAddressPath, ethValue, tokenAmount, 0])
                            ...
                            return (
                              <Card key={index} my={'10px'}>
                                ...
                                <Flex alignItems={'center'} mb='10px'>
                                  ...
                                  {(parseInt(tx[6]._hex) >=confirmNum && !tx[5])?(
                                    <>
                                      <Web3Button
                                      contractAddress={TOKEN_TREASURY_ADDRESS}
                                      action={async()=>{
                            ...
                            return (
                              <Card key={index} my={'10px'}>
                                ...
                                <Flex alignItems={'center'} mb='10px'>
                                  ...
                                  <Flex alignItems={'center'} mb='10px'>                                
                                    <Text fontWeight={'bold'} fontSize='' mr='10px'>
                                    添增ETH：{parseInt(tx[2]._hex) / 1e18} ETH
                                    </Text>
                                  </Flex> 
                                  <Flex alignItems={'center'} mb='10px'>                                
                                    <Text fontWeight={'bold'} fontSize='' mr='10px'>
                                    Token幣量：{parseInt(tx[3]._hex) / 1e18} 顆
                                    </Text>
                                  </Flex> 
                                  <Flex alignItems={'center'} mb='10px'>                                
                                    <Text fontWeight={'bold'} fontSize='' mr='10px'>
                            ...
                            return (
                              <Card key={index} my={'10px'}>
                                ...
                                <Flex alignItems={'center'} mb='10px'>
                                  ...
                                  <Flex alignItems={'center'} mb='10px'>                                
                                    <Text fontWeight={'bold'} fontSize='' mr='10px'>
                                    移除份額：{parseInt(tx[2]._hex) / 1e18} 顆
                                    </Text>
                                  </Flex> 
                                  <Flex alignItems={'center'} mb='10px'>                                
                                    <Text fontWeight={'bold'} fontSize='' mr='10px'>
            ...
            <Box>
              <Card maxH={'50vh'} overflow={'scroll'}>
                  <CardBody>
                      ...
                      {!loadingTransactions ? (
                        <Box>
                          {transactions && transactions?.filter(tx => tx[5]).map((tx, index)=>{
                            if (tx[0] == 0){
                              return (
                                <Card key={index} my={'10px'}>
                                  <CardBody>
